...
set.seed(1234)
gdrive_folder <- "GEE_Exports_resilience_20251130"
...
#Create full raw dats file if doesn't exist
raw_dats_fl <- here(dir_derived, "raw_test_dats.parquet")
...
# Deal with response data (VCF & RAP)
